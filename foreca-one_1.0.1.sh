...
echo -e "${CYAN}"
echo "################################################################"
echo "#   Start downloading and installing foreca-one_1.0.1 plugin   #"
echo "################################################################"
echo -e "${NC}"

IPK_URL="https://raw.githubusercontent.com/Ham-ahmed/083/refs/heads/main/enigma2-plugin-extensions-foreca-one_1.0.1_all.ipk"
IPK_NAME="enigma2-plugin-extensions-foreca-one_1.0.1_all.ipk"
